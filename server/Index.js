...
async function run() {
  try {
    ...
    app.post("/blog/:id/comments/:commentId/replies/:replyId/reply", async (req, res) => {
    ...
    // Like/unlike a reply
    app.post("/blog/:id/comments/:commentId/replies/:replyId/like", async (req, res) => {
      const { commentId, replyId } = req.params;
      const { userId } = req.body;
      try {
        const comment = await commentsCollection.findOne({ _id: new ObjectId(commentId) });
    ...
    // Edit a reply
    app.put("/blog/:id/comments/:commentId/replies/:replyId", async (req, res) => {
      const { commentId, replyId } = req.params;
      const { text } = req.body;
      try {
        await commentsCollection.updateOne(
    ...
    // Delete a reply
    app.delete("/blog/:id/comments/:commentId/replies/:replyId", async (req, res) => {
      const { commentId, replyId } = req.params;
      try {
        await commentsCollection.updateOne(
          { _id: new ObjectId(commentId) },

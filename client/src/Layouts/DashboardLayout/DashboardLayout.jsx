  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white shadow-lg">
        <div className="sticky top-0 bg-white py-4 border-b border-gray-200">
          <span className="text-xl font-bold text-orange-500 pl-4">BuyNex</span>
        </div>
      ...
      <div
        className={`fixed inset-0 z-40 bg-black/30 bg-opacity-40 transition-opacity duration-300 ${
          sidebarOpen
